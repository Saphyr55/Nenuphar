...
template<Real R>
constexpr Vector3<R>::Vector3(Vector2<R> vec, R z) : Vector3(vec.x, vec.y, z) {}

template<Real R>
constexpr Vector3<R>::Vector3(R x, R y, R z) : x(x), y(y), z(z) {}

template<Real R>
constexpr Vector3<R>::Vector3(R r) : Vector3(r, r, r) {}
