...
class SBApplicationMessageHandler : public Np::ApplicationMessageHandler
{
public:
...
public:
    explicit SBApplicationMessageHandler(Np::SharedRef<WindowEventHandler> windowEventHandler)
